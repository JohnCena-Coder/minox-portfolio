...
export default function ProjectManager() {
  ...
  return (
    // FIX LAYOUT: Dùng h-full và flex-col để đảm bảo chiếm hết chiều cao màn hình
    <div className="flex flex-col h-full w-full bg-white">
        ...
        {/* CONTENT AREA: Sử dụng min-h-0 để fix lỗi scroll flexbox */}
        <div className="flex-1 flex overflow-hidden min-h-0">
            ...
            {/* RIGHT COLUMN: EDITOR */}
            {/* FIX: h-full, overflow-y-auto và pb-40 để scroll thoải mái */}
                    ...
                    <div className="max-w-3xl mx-auto p-8 space-y-8">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            className="w-full p-3 border border-gray-200 font-vibe font-medium outline-none focus:border-black bg-white uppercase text-xs"
                                        >
                        ...
                        <div>
                            <div className="flex justify-between items-end mb-4 px-1">
                                <h2 className="font-vibe uppercase tracking-widest text-sm font-bold text-gray-400">
                                    Items ({selectedProject.items.length})
                                </h2>
                                <button onClick={handleAddItem} className="bg-white text-black border border-black px-4 py-2 font-vibe uppercase tracking-widest text-[10px] font-bold hover:bg-black hover:text-white transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px]">
                                    + Add Item
                                </button>
                            </div>

                            {/* FIX: flex-col gap-6 để các item không dính chùm */}
                            <div className="flex flex-col gap-8">
                                {selectedProject.items.map((item, idx) => (
                                    // FIX: shrink-0 để item không bị ép nhỏ lại
                                    <div key={idx} className="bg-white border border-gray-200 p-6 relative group shrink-0 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <div className="flex justify-between items-start mb-6 border-b border-gray-100 pb-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <input 
                                                    value={item.title} 
                                                    onChange={(e:any) => handleUpdateItem(idx, 'title', e.target.value)}
                                                    className="font-vibe font-bold uppercase text-sm outline-none border-b border-transparent focus:border-black transition-colors min-w-[200px]"
                                            ...
                                            >
                                                <span className="font-vibe uppercase text-[10px] font-bold">Remove</span>
                                            </button>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea 
                                                        ...
                                                        className="w-full p-3 border border-gray-200 font-vibe font-medium outline-none focus:border-black bg-gray-50 focus:bg-white text-xs h-24 resize-none leading-relaxed"
                                            ...
                                            <div>
                                                {selectedProject.type === 'review' ? (
                                                    <div className="grid grid-cols-2 gap-3">
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="aspect-square bg-gray-100 border border-gray-200 relative group/upload overflow-hidden">
                                                                ...
                                                                <label className="absolute inset-0 bg-black/80 opacity-0 group-hover/upload:opacity-100 flex items-center justify-center cursor-pointer transition-opacity">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="aspect-square bg-gray-100 border border-blue-200 relative group/upload overflow-hidden">
                                                                ...
                                                                <label className="absolute inset-0 bg-blue-600/90 opacity-0 group-hover/upload:opacity-100 flex items-center justify-center cursor-pointer transition-opacity">
                                                                    <span className="text-white text-[10px] font-vibe font-bold uppercase">Upload</span>
                                                    ...
                                                    <div className="h-full bg-gray-50 border border-dashed border-gray-300 p-4 flex flex-col items-center justify-center text-center">
                                                        <div className="flex flex-wrap gap-2 justify-center mb-4">
                                                            {item.gallery_imgs?.map((img, i) => (
                                                                <img key={i} src={img} className="w-10 h-10 object-cover border border-gray-300" />
                                                            ))}
                                                        </div>
                                                        <label className="cursor-pointer bg-white border border-gray-300 px-3 py-2 text-[10px] font-vibe font-bold uppercase hover:bg-black hover:text-white transition-colors">
