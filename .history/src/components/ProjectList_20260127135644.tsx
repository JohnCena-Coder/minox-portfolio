      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 transition-opacity duration-300">
        <aside className="md:col-span-3 h-fit sticky top-24">
            <div className="border-l-2 border-black pl-6 py-2">
                ...
                <div className="mt-12">
                     <p className="text-[10px] font-bold tracking-widest uppercase mb-4 text-gray-400">Total</p>
                     <p className="font-mono text-xl font-bold">{projects.length}</p>
                </div>
            </div>
        </aside>
                                        ...
                                        <div className="space-y-4">
                                            {item.gallery_imgs?.map((img, idx) => (
                                                <div 
                                                    ...
                                                    onClick={() => setZoomedImg(img)} // Bắt sự kiện Click để Zoom
                                                >
                                                    {/* SỬA: Dùng w-full h-auto để hiển thị đúng kích thước thật, không bị cắt */}
